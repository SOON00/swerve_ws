...
def generate_launch_description():
    ...
    turtlebot3_cartographer_prefix = get_package_share_directory('swerve_cartographer')
    ...
    rviz_config_dir = os.path.join(get_package_share_directory('swerve_cartographer'),
                                   'rviz', 'swerve_cartographer.rviz')
    
    rsp = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            os.path.join(get_package_share_directory('swerve_bot'), 'launch', 'rsp.launch.py')
        ]),
