...
def load_cbf_segments():
    ...
    yaml_path = pkg_root / "params" / "cbf_acute_26.yaml"
...
if __name__ == "__main__":
    ...
    # Walls
    plt.plot([1, 5 + math.sqrt(5)],[ 0.5,  0.5],'b',linewidth=1.5) 
    plt.plot([1, 5 + math.sqrt(5)],[-1.5 - math.sqrt(5)/2,  0.5],'b',linewidth=1.5)
      
    # Inner
    plt.plot([1, 3],[-0.5, -0.5],'b',linewidth=1.5)
    plt.plot([1, 3],[-1.5, -0.5],'b',linewidth=1.5)
