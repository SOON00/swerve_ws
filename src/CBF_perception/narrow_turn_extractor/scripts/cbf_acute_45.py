...
def load_cbf_segments():
    ...
    yaml_path = pkg_root / "params" / "cbf_acute_45.yaml"
...
if __name__ == "__main__":
    ...
    # Walls
    # Outer
    plt.plot([1, 5.414],[ 0.5,  0.5],'b',linewidth=1.5) 
    plt.plot([1, 5.414],[-3.914, 0.5],'b',linewidth=1.5)
      
    # Inner
    plt.plot([1, 3],[-0.5, -0.5],'b',linewidth=1.5)
    plt.plot([1, 3],[-2.5, -0.5],'b',linewidth=1.5)
